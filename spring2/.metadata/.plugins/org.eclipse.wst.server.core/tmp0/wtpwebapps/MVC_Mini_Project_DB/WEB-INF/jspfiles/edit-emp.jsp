...
FirstName <input type="text" name="fname1" value="${Existing_EMP_Data.firstname}"></br></br>
LastName <input type="text" name="lname1" value="${Existing_EMP_Data.lastname}"></br></br>
